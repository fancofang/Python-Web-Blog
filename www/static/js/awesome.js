...
if (typeof(Vue)!=='undefined') {
    ...
    Vue.component('pagination', {
        template: '<ul class="uk-pagination fa">' +
                '<li v-if="! has_previous" class="uk-disabled"><span><i class="fa-fast-backward"></i></span></li>' +
                '<li v-if="has_previous"><a v-attr="onclick:\'gotoPage(\' + (page_index-1) + \')\'" href="#0"><i class="fa-angle-left"></i></a></li>' +
                '<li class="uk-active"><span v-text="page_index"></span></li>' +
                '<li v-if="! has_next" class="uk-disabled"><span><i class="fa-fast-forward"></i></span></li>' +
                '<li v-if="has_next"><a v-attr="onclick:\'gotoPage(\' + (page_index+1) + \')\'" href="#0"><i class="fa-angle-right"></i></a></li>' +
            '</ul>'
    });
}
